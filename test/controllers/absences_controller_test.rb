...
class AbsencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create absence" do
    assert_difference("Absence.count") do
      post absences_url, params: { absence: { absent_game_day: @absence.absent_game_day, absent_train_day: @absence.absent_train_day, player_id: @absence.player_id, reason: @absence.reason } }
    end
  ...
  test "should update absence" do
    patch absence_url(@absence), params: { absence: { absent_game_day: @absence.absent_game_day, absent_train_day: @absence.absent_train_day, player_id: @absence.player_id, reason: @absence.reason } }
